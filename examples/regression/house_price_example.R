...
# Import from GitHub
train = h2o.importFile("https://github.com/woobe/h2o_training_2018_02/raw/master/examples/regression/house_price_train.csv")
test = h2o.importFile("https://github.com/woobe/h2o_training_2018_02/raw/master/examples/regression/house_price_test.csv")
...
h2o.performance(model_drf, newdata = test)
...
h2o.performance(model_dnn, newdata = test)
...
aml = h2o.automl(x = features,
                 ...
                 max_runtime_secs = 30, # increase this to build more models
                 max_models = 50) # set a hard limit of no. of models
...
h2o.performance(model_best, newdata = test)
