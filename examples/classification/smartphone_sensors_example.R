...
# Import from GitHub
# train = h2o.importFile("https://github.com/woobe/h2o_training_2018_02/raw/master/examples/classification/smartphone_sensors_train.csv.zip?raw=true")
# test = h2o.importFile("https://github.com/woobe/h2o_training_2018_02/raw/master/examples/classification/smartphone_sensors_test.csv.zip?raw=true")
